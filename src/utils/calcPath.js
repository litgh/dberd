import { ShowTableStyle, tableFieldHeight, tableWidth } from "@/constants/constants.js";


function calY(table, fieldId, tableStyle) {
  switch (tableStyle) {
...
export default function calPath(r, zoom = 1, tableStyle) {
  const width = tableWidth * zoom;
  let x1 = r.fromTable.x;
  let y1 = calY(r.fromTable, r.fromField, tableStyle);

  let x2 = r.toTable.x;
  let y2 = calY(r.toTable, r.toField, tableStyle);
